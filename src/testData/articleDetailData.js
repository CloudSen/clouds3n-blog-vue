...
\`\`\`
Access to XMLHttpRequest at 'http://localhost:8222/api/demo-for-test'
from origin 'http://localhost:8700' has been blocked by CORS policy: No 'Access-Control-Allow-Origin' header is present on the requested resource.
\`\`\`
...
`,
  deprecated: true,
  imgUrl: 'https://s2.ax1x.com/2019/08/24/m6SMB8.png',
}
